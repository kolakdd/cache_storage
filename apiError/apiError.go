...
var (
	// auth error
	PasswordToEasy = &BackendErrorInternal{98, "Пароль слишком простой", http.StatusBadRequest}
	LoginToEasy    = &BackendErrorInternal{99, "Логин слишком простой", http.StatusBadRequest}
