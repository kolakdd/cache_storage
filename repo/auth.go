...
import (
	...
	"github.com/kolakdd/cache_storage/utils"
	"github.com/redis/go-redis/v9"
	uuid "github.com/satori/go.uuid"
	"golang.org/x/crypto/bcrypt"
)

// AuthRepo отвечает за действия, происходящии при авторизации и при регистрации
...
func (r *authRepo) CreateUser(dto *models.RegisterDto) (*models.RegisterUserRequest, *apiError.BackendErrorInternal) {
	bytes, _ := bcrypt.GenerateFromPassword([]byte(dto.Pswd), bcrypt.DefaultCost)
	dto.Pswd = string(bytes)
...
func (r *authRepo) GetUserID(dto *models.AuthDto) (*uuid.UUID, *apiError.BackendErrorInternal) {
	...
	case nil:
		err := bcrypt.CompareHashAndPassword([]byte(hashPassword), []byte(dto.Pswd))
		if err != nil {
